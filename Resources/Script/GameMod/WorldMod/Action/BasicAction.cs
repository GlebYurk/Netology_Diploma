...
namespace WorldMode
{
    ...
    public class BasicAction
    {
        ...
        protected IEnumerator rotateBase(float rotateX, float rotateY, float rotateZ)
        {
            ...
            Vector3 finalPoint = (_startRotation + new Vector3(rotateX, rotateY, rotateZ));
            finalPoint.x %= 360;
            finalPoint.y %= 360;
            finalPoint.z %= 360;
            ...
            _actionLiveForm.GetGameObject().transform.eulerAngles = finalPoint;
            _coroutineRunning =false;
            yield return null;
        }
